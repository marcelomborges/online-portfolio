...
- **Admin:** minimal motion; prefer Nuxt UI. **Tenant:** motion stack per slug — [Vue Bits](https://vue-bits.dev/) OK em `public/tenants/{slug}/` (jsrepo/shadcn); never import motion libs in `components/app/`.
