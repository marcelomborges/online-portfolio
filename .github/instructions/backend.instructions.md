...
- **Language:** English for code, comments, logs, and internal exceptions; **pt-BR** only in API/email `message` fields shown to users — [language.instructions.md](./language.instructions.md). Copilot: do not suggest Portuguese comments or log lines.
...
- **Cross-stack:** API/DTO/auth/env changes usually need matching frontend proxy, types, or pages — see `docs/AGENT_GUIDE.md`.- See `docs/DATABASE.md` and `docs/ARCHITECTURE.md`.
