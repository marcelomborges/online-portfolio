...
{
    /// <inheritdoc />
    public partial class InitialMultiTenantAndUsers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    max_artworks = table.Column<int>(type: "integer", nullable: false),
                    custom_domain_allowed = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    custom_domain_verified_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("chk_tenants_slug_format", "slug ~ '^[a-z0-9]([a-z0-9-]{1,61}[a-z0-9])?$'");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_asp_net_users_asp_net_users_invited_by_user_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_asp_net_users_invited_by_user_id",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "tenant_id IS NOT NULL AND email IS NOT NULL");
